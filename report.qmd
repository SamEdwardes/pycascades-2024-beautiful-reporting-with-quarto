...
fig.write_image("output/images/plot-content-by-programming-language.png", width=400, height=250, scale=1)
```
...
fig.write_image("output/images/plot-last-user-login.png", width=400, height=250, scale=1)
```
